...
import com.pci.beacon.BeaconLocalBroadcastProcessor;
...
import com.pci.beacon.distance.DistanceCalculator;
import com.pci.beacon.distance.ModelSpecificDistanceCalculator;
import com.pci.beacon.logging.LogManager;
import com.pci.beacon.service.scanner.CycledLeScanCallback;
import com.pci.beacon.startup.StartupBroadcastReceiver;
import com.pci.beacon.utils.ProcessUtils;
import com.pci.bluetooth.BluetoothCrashResolver;
...
public class BeaconService extends Service {
                ...
                if (startRMData != null) {
                    switch (msg.what) {
                        case MSG_START_RANGING:
                            ...
                            service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.pci.beacon.service.Callback(startRMData.getCallbackPackageName()));
                        ...
                        case MSG_START_MONITORING:
                            ...
                            service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.pci.beacon.service.Callback(startRMData.getCallbackPackageName()));
                            service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod(), startRMData.getBackgroundFlag());
                            break;
    ...
    public void onCreate() {
        ...
        try {
            Class klass = Class.forName("com.pci.beacon.SimulatedScanData");
            java.lang.reflect.Field f = klass.getField("beacons");
            mScanHelper.setSimulatedScanData((List<Beacon>) f.get(null));
        } catch (ClassNotFoundException e) {
            LogManager.d(TAG, "No com.pci.beacon.SimulatedScanData class exists.");
        } catch (Exception e) {
            LogManager.e(e, TAG, "Cannot get simulated Scan data.  Make sure your com.pci.beacon.SimulatedScanData class defines a field with the signature 'public static List<Beacon> beacons'");
        }
