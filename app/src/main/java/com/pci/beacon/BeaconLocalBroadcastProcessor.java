...
public class BeaconLocalBroadcastProcessor {
    ...
    public static final String RANGE_NOTIFICATION = "com.pci.beacon.range_notification";
    public static final String MONITOR_NOTIFICATION = "com.pci.beacon.monitor_notification";
