 ...
 */
package com.pci.beacon.logging;

/**
 * Logging interface for logging messages in the android-beacon-library. To set a custom logger
 * implement this interface and set it with {@link com.pci.beacon.logging.LogManager#setLogger(Logger)}.
 *
 * @author Andrew Reitz
 * @see com.pci.beacon.logging.LogManager
 * @since 2.2
 */
